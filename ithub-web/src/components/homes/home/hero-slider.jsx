...
const { hero_shape, hero_title, sub_title, hero_shape_img, hero_thumbs } = hero_content;
              ...
              <div className="col-xl-10">
                <div className="tp-hero__content-box text-center z-index-3">
                  <div className="tp-hero__title-box p-relative">
                    <h2 className="tp-hero__hero-title tp-title-anim">{hero_title}</h2>
                              ...
                              {hero_thumbs.map((item, i) => (
                                <div key={i} className={`col-md-${item.col}`}>
                                  <div className={`tp-hero__thumb ${item.cls}`}>
                                    <Image className="w-100" src={item.img} alt="theme-pure" />
                                  </div>
                                </div>
                              ))}
                            </div>
